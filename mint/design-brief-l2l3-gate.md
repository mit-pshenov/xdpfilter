# Design Brief — L2/L3 demux gate-rework: EtherType + IPv6, and the slice sequence
...
architects:
  ...
  sequential:
    - name: sequencer
      ...
      inputs: [gate, addr-axis, ethertype]
      sources:
